...
1.Генерировать код классов с методами и операторами вывода

2.Поддерживать различные языки программирования без изменения клиентского кода

3.Использовать паттерн проектирования "Абстрактная фабрика"

4.Обеспечить лёгкое добавление новых языков программирования

5.Генерировать корректный компилируемый код для каждого целевого языка

# Отслеживаемые конструкции:
1.Класс (с модификаторами доступа)

2Метод (с модификаторами static, virtual, const)

3.Оператор вывода текста
